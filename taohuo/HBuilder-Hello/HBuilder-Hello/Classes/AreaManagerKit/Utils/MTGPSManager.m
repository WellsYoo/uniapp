...
@interface MTGPSManager () <CLLocationManagerDelegate>
...
@implementation MTGPSManager

+ (instancetype)shared {
    
    static MTGPSManager *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[MTGPSManager alloc] init];
    });
...
+ (void)requestGPSWithCompletionHandler:(MTGPSCompletionHandler)handler {
    ...
    [[MTGPSManager shared] startUpdatingLocationWithHandler:handler];
}
