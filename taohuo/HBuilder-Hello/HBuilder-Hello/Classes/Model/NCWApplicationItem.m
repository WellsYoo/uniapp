...
@implementation NCWApplicationItem
...
+ (NSMutableArray *)appItemsWithArray:(NSArray *)array
{
    ...
    for (NSDictionary *dictionary in array) {
        NCWApplicationItem *appItem = [[NCWApplicationItem alloc] initWithDictionary:dictionary];
...
- (BOOL)isEqual:(id)object
{
    ...
    NCWApplicationItem * tempItem =(NCWApplicationItem*)object;
