...
@interface ZBWWidgetInfoManager()
...
@implementation ZBWWidgetInfoManager
...
- (BOOL)saveToWidget
{
    ...
    NSURL * contentURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:[ZBWWidgetInfoManager groupIdentifier]];
