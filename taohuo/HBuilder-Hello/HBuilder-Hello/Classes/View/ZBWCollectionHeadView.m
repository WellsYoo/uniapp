...
@interface ZBWCollectionHeadView(){
    UIView   *_topView;
    UILabel  *_tipLabel;
...
@implementation ZBWCollectionHeadView
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _switchButton = [[UISwitch alloc] init];
         NSUserDefaults * widgetDefaults = [[NSUserDefaults alloc] initWithSuiteName:[ZBWWidgetInfoManager groupIdentifier]];
