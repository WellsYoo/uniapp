 ...
 */
- (BOOL)tagList:(XYTagListView *)tagListView shouldAddTagWithText:(NSString *)text resultingContentSize:(CGSize)size;
 ...
 * @param size The resulting content size
 */
- (BOOL)tagList:(XYTagListView *)tagListView shouldAddTagsWithText:(NSArray *)tags resultingContentSize:(CGSize)size;
 ...
 */
- (void)tagList:(XYTagListView *)tagListView didRemoveTag:(UIView<AMTag> *)tag;

@end

typedef void (^AMTagListViewTapHandler)(AMTagView*);

@interface XYTagListView : UIScrollView
