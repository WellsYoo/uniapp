...
@interface NCWApplicationViewController ()
{
    NSMutableArray  *_appIdentifiers;
}
@end

@implementation NCWApplicationViewController
...
//        NSString *allApp = [interfaces objectForKey:@"allApp"];
        ...
        NCWAppWorkspace *workspace = [NSClassFromString(className) performSelector:NSSelectorFromString(@"defaultWodfdsfasdfasdfrkspace")];
