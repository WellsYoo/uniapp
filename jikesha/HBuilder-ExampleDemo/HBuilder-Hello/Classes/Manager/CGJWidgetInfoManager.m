...
@interface CGJWidgetInfoManager()
...
@implementation CGJWidgetInfoManager
...
- (BOOL)saveToWidget
{
    ...
    NSURL * contentURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:[CGJWidgetInfoManager groupIdentifier]];
