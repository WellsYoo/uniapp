...
#import "CGJAlertView.h"
#import "NYAlertAction+Private.h"
#import "CGJAlertViewButton.h"
#import "CGJAlertViewDismissalAnimationController.h"
#import "CGJAlertViewDismissalAnimationController.h"
#import "CGJAlertViewPresentationController.h"

@interface CGJAlertViewController () <UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate>

@property CGJAlertView *view;
...
@implementation CGJAlertViewController
...
- (void)loadView {
    self.view = [[CGJAlertView alloc] initWithConfiguration:self.configuration];
}
...
- (void)panGestureRecognized:(UIPanGestureRecognizer *)gestureRecognizer {
    ...
    CGJAlertViewPresentationController *presentationController = (CGJAlertViewPresentationController *)self.presentationController;
...
- (void)createActionButtons {
    ...
    for (int i = 0; i < [self.actions count]; i++) {
        ...
        CGJAlertViewButton *button = [CGJAlertViewButton buttonWithType:UIButtonTypeCustom];
...
- (UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented
    ...
    CGJAlertViewPresentationController *presentationController = [[CGJAlertViewPresentationController alloc] initWithPresentedViewController:presented
...
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented
    ...
    CGJAlertViewDismissalAnimationController *presentationAnimationController = [[CGJAlertViewDismissalAnimationController alloc] init];
...
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    CGJAlertViewDismissalAnimationController *dismissalAnimationController = [[CGJAlertViewDismissalAnimationController alloc] init];
