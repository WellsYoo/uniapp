...
@interface CGJSpringboardCell()<UIAlertViewDelegate>


@property(nonatomic, strong)CGJIconImageView *portraitView;
...
@implementation CGJSpringboardCell
...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _portraitView = [[CGJIconImageView alloc] init];
