...
@implementation DBJListHeadView
...
//    _selectedView.frame = frame;
    ...
    for(int i = 0; i < _count; i++)
    {
        ...
        DBJSegmentButton *btn = [[DBJSegmentButton alloc] initWithFrame:CGRectMake(orginX, 0, width, _scrollView.bounds.size.height)];
        btn.tag = i;
