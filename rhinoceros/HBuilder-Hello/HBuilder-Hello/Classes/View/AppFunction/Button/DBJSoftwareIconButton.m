...
@interface DBJSoftwareIconButton ()
{
//    UIImageView *_iconView;
    UIImageView *_checkView;
    UILabel     *_title;
    DBJIconImageView *_iconView;
...
@implementation DBJSoftwareIconButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _iconView = [[DBJIconImageView alloc] initWithFrame:CGRectMake(7.5, 8,
