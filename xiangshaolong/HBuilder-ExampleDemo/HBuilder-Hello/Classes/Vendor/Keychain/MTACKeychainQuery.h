...
NS_ASSUME_NONNULL_BEGIN
	...
	#define MTACKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define MTACKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef MTACKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, MTACKeychainQuerySynchronizationMode) {
	MTACKeychainQuerySynchronizationModeAny,
	MTACKeychainQuerySynchronizationModeNo,
	MTACKeychainQuerySynchronizationModeYes
};
#endif
...
@property (nonatomic) MTACKeychainQuerySynchronizationMode synchronizationMode;
#endif
