...
@interface CCCollectionHeadView(){
    UIView   *_topView;
    UILabel  *_tipLabel;
...
@implementation CCCollectionHeadView
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _switchButton = [[UISwitch alloc] init];
         NSUserDefaults * widgetDefaults = [[NSUserDefaults alloc] initWithSuiteName:[XSLWidgetInfoManager groupIdentifier]];
