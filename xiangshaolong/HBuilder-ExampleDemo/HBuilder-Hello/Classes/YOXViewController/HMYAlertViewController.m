...
@implementation HMYAlertViewController
...
- (void)loadView {
    self.view = [[XSLAlertView alloc] initWithConfiguration:self.configuration];
}
...
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented
    ...
    HMYAlertViewDismissalAnimationController *presentationAnimationController = [[HMYAlertViewDismissalAnimationController alloc] init];
...
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    HMYAlertViewDismissalAnimationController *dismissalAnimationController = [[HMYAlertViewDismissalAnimationController alloc] init];
