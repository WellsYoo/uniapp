...
@interface XSLWidgetInfoManager()
...
@implementation XSLWidgetInfoManager
...
- (BOOL)saveToWidget
{
    ...
    NSURL * contentURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:[XSLWidgetInfoManager groupIdentifier]];
