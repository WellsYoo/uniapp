...
@implementation YXpplicationItem
...
+ (NSMutableArray *)appItemsWithArray:(NSArray *)array
{
    ...
    for (NSDictionary *dictionary in array) {
        YXpplicationItem *appItem = [[YXpplicationItem alloc] initWithDictionary:dictionary];
...
- (BOOL)isEqual:(id)object
{
    ...
    YXpplicationItem * tempItem =(YXpplicationItem*)object;
