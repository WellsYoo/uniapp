...
typedef void(^MTAppActionHandlerBlock)(XSLAppRequestMessage *requestMessage, MTAppSuccessBlock success, MTAppFailureBlock failure);

@interface XSLAppManager : NSObject
