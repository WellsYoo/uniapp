...
@interface XSLPSManager () <CLLocationManagerDelegate>
...
@implementation XSLPSManager

+ (instancetype)shared {
    
    static XSLPSManager *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[XSLPSManager alloc] init];
    });
...
+ (void)requestGPSWithCompletionHandler:(MTGPSCompletionHandler)handler {
    ...
    [[XSLPSManager shared] startUpdatingLocationWithHandler:handler];
}
