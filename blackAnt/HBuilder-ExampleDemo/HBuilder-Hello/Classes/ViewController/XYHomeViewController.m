...
#import "HMYSpringboardLayout.h"
#import "XYWidgetInfoManager.h"
#import "XYCollectionHeadView.h"
...
@interface XYHomeViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, GSSpringboardCellDelegate,GSSpringboardDataSource,ABPeoplePickerNavigationControllerDelegate,UIActionSheetDelegate>
...
-(void)__buildView{
    ...
    HMYSpringboardLayout * layout = [[HMYSpringboardLayout alloc] initWithType:GS_SBLayoutTypeScroll];
    ...
    [self.collectionView registerClass:[XYCollectionHeadView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:NCWCollectionViewHeadIdentifier];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (kind == UICollectionElementKindSectionHeader) {
            ...
            if (indexPath.section == 0) {
                XYCollectionHeadView *headView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:NCWCollectionViewHeadIdentifier forIndexPath:indexPath];
