...
/**
 Error code specific to MTACKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, MTACKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	MTACKeychainErrorBadArguments = -1001,
};

/** MTACKeychain error domain */
extern NSString *const kMTACKeychainErrorDomain;

/** Account name. */
extern NSString *const kMTACKeychainAccountKey;
 ...
 */
extern NSString *const kMTACKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kMTACKeychainClassKey;

/** Item description. */
extern NSString *const kMTACKeychainDescriptionKey;

/** Item label. */
extern NSString *const kMTACKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kMTACKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kMTACKeychainWhereKey;
...
/**
 ...
 MTACKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in MTACKeychain.h for a list of keys that can be used when accessing the
