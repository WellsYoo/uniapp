...
@interface CCTextRenderer : NSObject

/**
 Stored attachments info and it's useful for drawing.
 */
@property (nullable, nonatomic, strong, readonly) CCTextAttachmentsInfo *attachmentsInfo;
...
@interface CCTextRenderer (MPITextKitExtendedRenderer)
