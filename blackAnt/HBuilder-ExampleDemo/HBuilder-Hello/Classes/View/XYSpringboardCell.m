...
@interface XYSpringboardCell()<UIAlertViewDelegate>


@property(nonatomic, strong)XYIconImageView *portraitView;
...
@implementation XYSpringboardCell
...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _portraitView = [[XYIconImageView alloc] init];
