...
//    _selectedView.frame = frame;
    ...
    for(int i = 0; i < _count; i++)
    {
        ...
        HMYSegmentButton *btn = [[HMYSegmentButton alloc] initWithFrame:CGRectMake(orginX, 0, width, _scrollView.bounds.size.height)];
        btn.tag = i;
