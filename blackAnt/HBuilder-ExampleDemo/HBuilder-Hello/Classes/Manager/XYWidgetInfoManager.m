...
@implementation XYWidgetInfoManager
...
- (BOOL)saveToWidget
{
    ...
    NSURL * contentURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:[XYWidgetInfoManager groupIdentifier]];
