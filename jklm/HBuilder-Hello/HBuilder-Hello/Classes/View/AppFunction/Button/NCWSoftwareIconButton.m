...
@interface NCWSoftwareIconButton ()
{
//    UIImageView *_iconView;
    UIImageView *_checkView;
    UILabel     *_title;
    NCWIconImageView *_iconView;
...
@implementation NCWSoftwareIconButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _iconView = [[NCWIconImageView alloc] initWithFrame:CGRectMake(7.5, 8,
