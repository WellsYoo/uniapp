 ...
 */
- (BOOL)tagList:(CGJTagListView *)tagListView shouldAddTagWithText:(NSString *)text resultingContentSize:(CGSize)size;
 ...
 * @param size The resulting content size
 */
- (BOOL)tagList:(CGJTagListView *)tagListView shouldAddTagsWithText:(NSArray *)tags resultingContentSize:(CGSize)size;
 ...
 */
- (void)tagList:(CGJTagListView *)tagListView didRemoveTag:(UIView<AMTag> *)tag;

@end

typedef void (^AMTagListViewTapHandler)(AMTagView*);

@interface CGJTagListView : UIScrollView
