...
@interface CGJtwareIconButton ()
{
//    UIImageView *_iconView;
    UIImageView *_checkView;
    UILabel     *_title;
    CGJIconImageView *_iconView;
...
@implementation CGJtwareIconButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _iconView = [[CGJIconImageView alloc] initWithFrame:CGRectMake(7.5, 8,
